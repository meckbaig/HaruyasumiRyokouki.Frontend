...
/**
 * Verifies credentials against GET /v1/admin/login. They travel in the
 * `Authorization` header, never in the URL - a query string leaks the password
 * into server logs, browser history and `Referer`.
 *
